...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        if ($didUpload) {
            ...
            $query = "INSERT INTO contact(firstname,lastname,email,phone,description,optradio,myfile) VALUES('$firstname','$lastname','$email','$phone','$description','$optradio','$fileName')";

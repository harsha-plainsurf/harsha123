        ...
        <div class="form row py-5">
            <div class="col-lg-6 contact-form">
                <form action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="radio" name="optradio" value="friends">friends &nbsp;


                    <input type="radio" name="optradio" value="social">social &nbsp;


                    <input type="radio" name="optradio" value="others">others &nbsp;

                    <img id="preview" src="$fileName" height="100px" width="100px" />
                    
                    <input type="file" name="myfile" id="myfile" class="form-control"  onchange="previewImage(this)" accept="myfile/*"/>
